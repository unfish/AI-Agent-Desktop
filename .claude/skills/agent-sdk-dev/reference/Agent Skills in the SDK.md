...
For more details on `settingSources`/`setting_sources`, see the [TypeScript SDK reference](./Agent%20SDK%20reference%20-%20TypeScript.md) or [Python SDK reference](./Agent%20SDK%20reference%20-%20Python.md).
