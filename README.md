...
2. **Rust** >= 1.70.0 ([安装指南](https://www.rust-lang.org/tools/install))
3. **Anthropic API Key** ([获取地址](https://console.anthropic.com/))
...
详细使用说明请查看 [agentClient/README.md](agentClient/README.md)
